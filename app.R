                 ...
                 sidebarLayout(
                   ...
                   mainPanel(
                     ...
                     fluidRow(
                       ...
                       column(width=3,img(src='coronavirus.jpg',height=350,width=350)),
                       column(width=3,tableOutput("world_Count_total"),offset=2)
                       ),
                     ...
                     fluidRow(
                       ...
                       column(width=6,plotOutput("time_series1"))
                     )
